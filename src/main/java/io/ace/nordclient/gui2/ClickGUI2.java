...
{
    public static ArrayList<io.ace.nordclient.gui2.Frame> frames;
    public static int color;


    public ClickGUI2() {
        ClickGUI2.frames = new ArrayList<io.ace.nordclient.gui2.Frame>();
        int frameX = 5;
        for (final Hack.Category category : Hack.Category.values()) {
            final io.ace.nordclient.gui2.Frame frame = new io.ace.nordclient.gui2.Frame(category);
            frame.setX(frameX);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (final io.ace.nordclient.gui2.Frame frame : ClickGUI2.frames) {
